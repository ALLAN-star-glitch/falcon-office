...
export default function Topbar() {
  ...
  return (
    <header className="flex justify-between items-center px-4 md:px-6 h-auto md:h-16 bg-gradient-to-r from-[#F9FBFF] to-[#FFFFFF] border-b border-[#E5E9F2] shadow-sm sticky top-0 z-50">
      {/* Left Section */}
      ...
      <div className="flex items-center gap-2 md:gap-3 flex-nowrap mt-2 md:mt-0">
        ...
        {/* Bulk SMS */}
        <button
          className="hidden md:flex items-center gap-1 md:gap-2 bg-gradient-to-r from-[#165DFC] to-[#4EA8FF] text-white font-medium px-2 md:px-4 py-1.5 md:py-2.5 rounded-xl shadow-md hover:shadow-lg hover:scale-[1.02] transition-all duration-200 cursor-pointer whitespace-nowrap"
